    ...
    <div>
      ...
      <a-table ref="TableInfo"
        ...
        <template slot="operation" slot-scope="text, record">
          <a-icon type="folder-open" theme="twoTone" @click="edit(record)" title="修 改"/>
        </template>
      </a-table>
    </div>
    <repair-add
...
export default {
  name: 'repair',
  components: {RepairAdd, RangeDate, RepairView},
  data () {
    return {
      startDate: null,
      endDate: null,
    ...
    columns () {
      return [{
        ...
        customRender: (text, row, index) => {
          switch (text) {
            case '1':
              return <a-tag>灭火器</a-tag>
            case '2':
              return <a-tag>路灯</a-tag>
            case '3':
              return <a-tag>水箱</a-tag>
            case '4':
              return <a-tag>电表</a-tag>
            case '5':
              return <a-tag>自动喷水器</a-tag>
            case '6':
              return <a-tag>单元门</a-tag>
            case '7':
              return <a-tag>电梯</a-tag>
            case '8':
              return <a-tag>公共窗户</a-tag>
            case '9':
              return <a-tag>墙壁</a-tag>
            default:
              return '- -'
          }
        }
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/community-repair-info/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/community-repair-info/page', {
        ...params
      }).then((r) => {
